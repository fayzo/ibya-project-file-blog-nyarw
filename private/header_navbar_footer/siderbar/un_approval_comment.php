...
?>
        <div class="well" style="margin:auto; padding:auto; width:100%;">
          <form class="needs-validation" novalidate id="formcomment"  method="post" enctype="multipart/form-data">
             ...
             <div id="uncomment_form" class="modal fade">
              ...
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div id="edit_uncomment">

                          <div class="form-group">
                             <input type="hidden" id="commt_editRowID" name="commt_editRowID" value="0">
                             <label for="firstName">Title</label>
                             <input type="text" name="title_uncomment" class="form-control" id="title_uncomment" placeholder="Title" value="" required>
                               <div class="invalid-feedback">
                                 Valid first name is required.
                               </div>

                             <label for="lastName">Athors</label>
                             <input type="text" name="athors_uncomment" class="form-control" id="athors_uncomment" placeholder="Athors" value="" required>
                               <div class="invalid-feedback">
                                 Valid last name is required.
                               </div>

                           <label for="username">Text</label>
                           <textarea class="form-control" name="textarea_uncomment" id="textarea_uncomment" rows="3"></textarea>
                             ...
                             <div class="input-group">
                                ...
                                <input type="email" class="form-control" name="email_uncomment" id="email_uncomment" placeholder="you@example.com" required>
                                  <div class="invalid-feedback">
                             ...
                             <input type="type" class="form-control" name="date_uncomment" id="date_uncomment" value="<?php echo $dateTimes; ?>" readonly>
                               <div class="invalid-feedback">
                                 Please enter your Date-Time.
                               </div>

                             <label for="address2">Address</label>
                             <input type="text" class="form-control" name="address_uncomment" id="address_uncomment" placeholder="Apartment or suite">

                              <label for="country">Country</label>
                              <select class="custom-select d-block w-100" name="country_uncomment" id="country_uncomment" required>
                              ...
                              <div class="invalid-feedback">
                               ...
                               <select class="custom-select d-block w-100" name="state_uncomment" id="state_uncomment" required>
                                 <option value="">Choose...</option>
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="button" id="btn_uncomment" onclick="manageData_uncomment('adduncomment')" value="Save" class="btn btn-success">
                        <input type="submit" id="uncomment_Save" value="Save Profile" class="btn btn-success">
        ...
        <div class="row mb-4">
            <div class="col-sm-md-lg-12 md-offset-2">
              <div class="text-center">
                <span class="h4">Un-Approval Comment : <span class="bg-danger rounded text-white">OFF<span></span>
              </div>
                <!-- <input style="float: right" type="button" class="btn btn-success" id="adduncomment" value="add Post"> -->
                <table class="table table-striped table-bordered table-hover table_uncomment" >
