         ...
         <div class="row">
                     ...
                     <div class="collapse show" id="collapseExample1">
                         <div class="card-body p-0">
                             <div class="list-group " id="list-tab" role="tablist">
                                 ...
                                 <a class="list-group-item list-group-item-action" id="list-Junk-list" data-toggle="tab"
                                     href="#list-Junk" role="tab" aria-controls="list-profile"><i
                                         class="fa fa-filter"></i> Junk
                                     <span class="badge badge-warning float-right">65</a>
             ...
             <div class="col-md-9">
                 ...
                 <div class="tab-content" id="nav-tabContent">
                     ...
                     <div class="tab-pane fade " id="list-Junk" role="tabpanel" aria-labelledby="list-Junk-list">
                         <?php include "message/junk.php"?>
                         ...
                         <ul class="mailbox-attachments clearfix">
                             ...
                             <li>
                                 <span class="mailbox-attachment-icon has-img"><img
                                         src="<?php echo BASE_URL_LINK_ALL ;?>image/img/photo1.png" alt="Attachment"></span>
                             ...
                             <li>
                                 <span class="mailbox-attachment-icon has-img"><img
                                         src="<?php echo BASE_URL_LINK_ALL ;?>image/img/photo2.png" alt="Attachment"></span>
