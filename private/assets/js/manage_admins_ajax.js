...
$(document).on('click', '.update_profile_id', function () {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            var userPicture = (response.profile_image) ? 'assets/image/uploads/' + response.profile_image
            ...
            var cover_userPicture = (response.cover_image) ? 'assets/image/uploads/' + response.cover_image
