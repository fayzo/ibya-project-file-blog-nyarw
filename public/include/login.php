...
<head>
    ...
    <link href="<?php echo BASE_URL_LINK_ALL ;?>dist/css/login.css" rel="stylesheet">
    ...
    <script src="<?php echo BASE_URL_LINK_ALL ;?>dist/js/country_login.js"></script>
...
<body>
    ...
    <script src="<?php echo BASE_URL_LINK_ALL ;?>dist/js/login.js"></script>
    <script>
