...
if(isset($_POST['key'])){
 ...
 if ($_POST['key'] == 'password') {
     ...
     if (strlen($password) > 8) {
        ...
        $user_createPassword_id= $users->update('users',array( 'password' => $password),$user_id);
        $_SESSION['keys'] = $user_createPassword_id;
          ...
          array('forgotUsernameCountsTimesHeCreatespassword' => 'forgotUsernameCountsTimesHeCreatespassword + 1'),$user_createPassword_id);
...
<body>
    <div class="container" id="container">
        ...
        <div class="lockscreen-image">
            <img src="<?php echo BASE_URL_LINK_ALL ;?>image/img/user1-128x128.jpg" alt="User Image">
        </div>
