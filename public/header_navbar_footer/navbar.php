<nav class="navbar navbar-expand-lg fixed-top">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link" href="<?php echo HOME ;?>"><i style="font-size: 22px;" class="fa fa-home"></i> <?php echo $lang['home'];?> <span class="sr-only">(current)</span></a>
      </li>
      <!-- <li class="nav-item">
        ...
        <ul class="navbar-nav ">
          ...
          <li class="dropdown notifications-menu nav-item">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="<?php echo NOTIFICATION ;?>">View all</a></li>
            </ul>
          </li>
                ...
                <ul class="menu">
                  <li><!-- Task item -->
                    <a href="#">
                      ...
                      <div class="progress xs">
                        <div class="progress-bar bg-secondary" style="width: 20%" role="progressbar"
                  ...
                  <li><!-- Task item -->
                    <a href="#">
                      ...
                      <div class="progress xs">
                        <div class="progress-bar bg-danger" style="width: 40%" role="progressbar"
                             aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">
...
<?php }else{?>
 <div class="navbar-nav">
      <div class="nav-item">
        <a class="nav-link" href="<?php echo LOGIN ;?>"><i style="font-size: 22px;" class="fa fa-home"></i>Have an account ? Login <span class="sr-only">(current)</span></a>
      </div>
  </div>
<?php }?>
  </div>
